...
**Q1** Which department has the highest mean (average) number of seats for its classes? You need to show the department with the highest average first. Which one is the most surprising/interesting to you? **A1 The department with the highest average if seats is** Computer, Math, and Natural Sciences**, with 440. I think it's interesting that xxxxxxxx**
